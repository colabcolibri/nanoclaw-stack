...
The authoritative checklist for writing a NanoClaw skill: the bar that conformance tooling and registry review will hold every skill to. o README do fork cobre a introdução; [skills-model.md](skills-model.md) explains why the model works this way. This document evolves with the system; when a rule here proves wrong, fix the rule.
